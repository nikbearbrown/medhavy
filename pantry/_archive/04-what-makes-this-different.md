...
![The four-layer integration stack. Four connected boxes in sequence: Tic TOC (curriculum design → concept node map) → Book Library...](images/archive-04-what-makes-this-different-fig-01.png)
*Figure 0.1 — four-layer integration stack*
